...
def save_metrics(test_results, model_dirs, current_epoch):
    ...
    print("test TOP1 Error (%) : {}".format(np.round(top1_error, 4) * 100))
    print("test TOP5 Error (%) : {}".format(np.round(top5_error, 4) * 100))
    print("###################### TEST REPORT ######################")
    ...
    f.write("test TOP1 Error (%) : {}\n".format(np.round(top1_error, 4) * 100))
    f.write("test TOP5 Error (%) : {}\n".format(np.round(top5_error, 4) * 100))
    f.write("###################### TEST REPORT ######################")
